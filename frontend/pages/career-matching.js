...
import { Search, User, Briefcase, TrendingUp, Loader2, ArrowLeft } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-3xl font-bold">AI-Powered Role Matching</h1>
                  <p className="text-blue-200 text-sm">Career Narrative Generation</p>
                </div>
              </div>
